        ...
        @foreach ($MobilatDetails as $details)
            <tr>
                <td>
                    ...
                    {!! Form::select('Prodact_name[]', $mobilats, $details->Prodact_name, ['class' => '  custom_select select2'   ]) !!}
                ...
                <td>
                  ...
                  <td>
                      {!! Form::textarea('notes[]', $details->notes, ['class' => ' form-control', 'placeholder' => 'ملاحظات']) !!}
                      <div class="show-error-amount invalid-feedback"></div>
                  </td>
                <td class="text-center">
