...
public function store(Request $request)
{
    ...
    for($i = 0 ; $i < count($request->Total); $i++){
        ...
        if ($countCleanHello !== 15 && $countCleanHello !== 18  && $countCleanHello !== 13 && $countCleanHello !== 11 && $countCleanHello !== 12 && $countCleanHello !== 14 ) {
...
public function update(Request $request, $id)
{
    ...
    for($i = 0 ; $i < count($request->sirarnamber); $i++){
        ...
        if ($countCleanHello !== 15 && $countCleanHello !== 18  && $countCleanHello !== 13 && $countCleanHello !== 12 && $countCleanHello !== 11 && $countCleanHello !== 14 ) {
        return response()->json(['errors' => [$error_count_array3]], 422);
        // save transition
        }
