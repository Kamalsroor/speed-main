...
class SearchController extends Controller
{
    ...
    function action($id)
    {
        ...
        //$itmes = array_merge($MobilatEx , $MobilatEnt);
      //  $itmesc = collect($itmes);
        $MobilatDetailss = MobilatDetails::where('Prodact_name', $id)->pluck('MobilatEntID')->unique();
        $test = MobilatDetails::where('Prodact_name', $id)->get()->pluck('MobilatEntID','id')->toArray();
